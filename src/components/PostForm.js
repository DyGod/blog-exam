    ...
    <Form onSubmit={submitPost}>
        ...
        <Row>
            ...
            <Form.Group>
                ...
                <Form.Control placeholder="Post Title" value={title} onChange={changeTitle} required />
            ...
            <Form.Group>
                ...
                <Form.Control as="select" custom value={category} onChange={e => setCategory(e.target.value)} required>
        ...
        <Form.Group>
            ...
            <Form.Control as="textarea" placeholder="Post Description" value={description} onChange={e => setDescription(e.target.value)} required />
        </Form.Group>
        ...
        <Form.Group>
            ...
            <Form.Control placeholder="author" value={author} onChange={setAuthor} readOnly />
        </Form.Group>
