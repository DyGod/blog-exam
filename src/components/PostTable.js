...
const PostTable = (props) => {
    ...
    const confirmDelete = () => {
        Fetch.deletePost(selectedPost.id).then( (res) => {
                ...
                <Row>
                    <Col>
                        <Form.Group>
                            ...
                            <Form.Control placeholder="Title" value={q} onChange={e => setQ(e.target.value) } />
                        </Form.Group>
                    </Col>
                    <Col>
                        <Form.Group>
                    ...
                    <Col>
                        <Form.Group>
                            ...
                            <Form.Control as="select" custom value={sort} onChange={e => setSort(e.target.value) }>
            ...
            <Table striped bordered hover>
                ...
                <tbody>
                    { posts.map( (p, i) => {
                        ...
                        <td><img src={p.thumbnail} alt="" height="75" width="75" /></td>
                        <td>
                            
                            <Button as={Link} to={"/post/" + p.slug} variant="outline-success" className="mr-2" size="sm"> <i className="fa fa-eye"></i> View</Button>
                            <Button as={Link} to={"/post-management/" + p.id} variant="outline-info" className="mr-2" size="sm"> <i className="fa fa-edit" ></i> Edit</Button>
                            <Button variant="outline-danger" size="sm" onClick={() => handleShowDelete(p) }> <i className="fa fa-trash"></i> Delete</Button>
                        </td>
                        </tr>
                    } )}
                </tbody>
